...
void help() {
    print("Usage: LoopTheSea status | preflight | breakfast | leg1 | leg1full | leg1rollover | ascend preflight | ascend | undersea | leg2 | postrun | rollover | run | fullday | reset", "teal");
